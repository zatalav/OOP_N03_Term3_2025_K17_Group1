...
public class dataQuanLyChuyenBay implements Dao_interface<ChuyenBay> {
    ...
    public int insert(ChuyenBay cb) {
        ...
        try {
            ...
            ps.setTimestamp(3, new java.sql.Timestamp(cb.getNgayGioKhoiHanh().getTime()));
    ...
    public ArrayList<ChuyenBay> selectAll() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                ChuyenBay cb = new ChuyenBay(maChuyenBay, tenChuyenBay, ngayGioKhoiHanh, soLuongGhe, GheVip,
                        GheHangNhat, GheThuong, diemKhoiHanh, diemDen, noiquoc);
                kq.add(cb);
            }
            JDBC.closeConnection(con);
        } catch (SQLException e) {
